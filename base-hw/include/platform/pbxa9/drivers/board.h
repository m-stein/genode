...
#ifndef _BASE_HW__INCLUDE__PLATFORM__PBXA9__DRIVERS__BOARD_H_
#define _BASE_HW__INCLUDE__PLATFORM__PBXA9__DRIVERS__BOARD_H_
...
#endif /* _BASE_HW__INCLUDE__PLATFORM__PBXA9__DRIVERS__BOARD_H_ */
