...
#ifndef _BASE_HW__INCLUDE__PLATFORM__PANDA_A2__DRIVERS__BOARD_H_
#define _BASE_HW__INCLUDE__PLATFORM__PANDA_A2__DRIVERS__BOARD_H_
...
#endif /* _BASE_HW__INCLUDE__PLATFORM__PANDA_A2__DRIVERS__BOARD_H_ */
