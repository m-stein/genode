...
#ifndef _BASE_HW__INCLUDE__ARM_V7A__BASE__SYSCALL_H_
#define _BASE_HW__INCLUDE__ARM_V7A__BASE__SYSCALL_H_
...
namespace Kernel
{
	 ...
	 **                                                             **
	 ** This functions must not be inline to ensure that objects,   **
...
#endif /* _BASE_HW__INCLUDE__ARM_V7A__BASE__SYSCALL_H_ */
