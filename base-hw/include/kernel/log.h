...
#ifndef _BASE_HW__INCLUDE__KERNEL__LOG_H_
#define _BASE_HW__INCLUDE__KERNEL__LOG_H_
		...
		public:
			...
			Kernel_log & operator << (unsigned int const & x)
			{
				...
				for (int i = IW - CW; i >= 0; i = i - CW)
				{
					...
					/* Print both digits of current part */
					_print_4bit_hex(c >> 4);
					_print_4bit_hex(c);
				}
				return *this;
...
#endif /* _BASE_HW__INCLUDE__KERNEL__LOG_H_  */
