...
#ifndef _BASE_HW__INCLUDE__BASE__IPC_PAGER_H_
#define _BASE_HW__INCLUDE__BASE__IPC_PAGER_H_
...
namespace Genode
{
	...
	class Ipc_pager : public Native_capability
	{
		...
		public:
			...
			{
				/* Check if we can distinguish message types */
...
#endif /* _BASE_HW__INCLUDE__BASE__IPC_PAGER_H_ */
