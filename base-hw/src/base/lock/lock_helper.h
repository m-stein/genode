...
#ifndef _BASE_HW__SRC__BASE__LOCK__LOCK_HELPER_H_
#define _BASE_HW__SRC__BASE__LOCK__LOCK_HELPER_H_
...
/**
 * Yield CPU to a specified thread
 */
static inline void
...
/**
 * Resume another thread and return if it were paused or not
 */
static inline bool
...
#endif /* _BASE_HW__SRC__BASE__LOCK__LOCK_HELPER_H_ */
