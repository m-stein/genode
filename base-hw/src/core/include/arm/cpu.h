...
namespace Arm
{
	...
	struct Cpu
	{
		...
		struct User_context : Context
		{
			 ...
			 *
			 * \retval 0  if the exception is unknown by the kernel
			 * \retval 1  if the exception is an interrupt
			 * \retval 2  if the exception is a pagefault
			 * \retval 3  if the exception is a syscall
			 */
