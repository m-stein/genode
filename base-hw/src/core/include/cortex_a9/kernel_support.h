...
#ifndef _BASE_HW__SRC__CORE__INCLUDE__CORTEX_A9__KERNEL_SUPPORT_H_
#define _BASE_HW__SRC__CORE__INCLUDE__CORTEX_A9__KERNEL_SUPPORT_H_
...
#endif /* _BASE_HW__SRC__CORE__INCLUDE__CORTEX_A9__KERNEL_SUPPORT_H_ */
