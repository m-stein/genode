...
#ifndef _BASE_HW__SRC__CORE__INCLUDE__SIGNAL_ROOT_H_
#define _BASE_HW__SRC__CORE__INCLUDE__SIGNAL_ROOT_H_
...
#endif /* _BASE_HW__SRC__CORE__INCLUDE__SIGNAL_ROOT_H_ */
