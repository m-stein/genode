...
#ifndef _BASE_HW__CORE__INCLUDE__SIGNAL_SESSION_COMPONENT_H_
#define _BASE_HW__CORE__INCLUDE__SIGNAL_SESSION_COMPONENT_H_
...
#endif /* _BASE_HW__CORE__INCLUDE__CAP_SESSION_COMPONENT_H_ */
