...
#ifndef _BASE_HW__SRC__CORE__INCLUDE__PLATFORM_PD_H_
#define _BASE_HW__SRC__CORE__INCLUDE__PLATFORM_PD_H_
...
namespace Genode
{
	...
	class Platform_pd
	{
		...
		Native_thread_id _main_thread; /* The first thread that gets executed in this PD */
...
#endif /* _BASE_HW__SRC__CORE__INCLUDE__PLATFORM_PD_H_ */
