...
#ifndef _BASE_HW__SRC__CORE__INCLUDE__UTIL_H_
#define _BASE_HW__SRC__CORE__INCLUDE__UTIL_H_
...
namespace Genode {
	 ...
	 */
	inline addr_t map_src_addr(addr_t core_local, addr_t phys)
	{
		/* Core runs physically */
		return phys;
	}
...
#endif /* _BASE_HW__SRC__CORE__INCLUDE__UTIL_H_ */
