...
#ifndef _BASE_HW__SRC__CORE__PANDA_A2__SOFTWARE_TLB_H_
#define _BASE_HW__SRC__CORE__PANDA_A2__SOFTWARE_TLB_H_
...
#endif /* _BASE_HW__SRC__CORE__PANDA_A2__SOFTWARE_TLB_H_ */
