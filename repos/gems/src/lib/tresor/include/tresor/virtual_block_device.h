...
class Tresor::Virtual_block_device_channel
{
	private:
		...
		enum State {
			...
			SUPPLY_CLIENT_DATA_FROM_LEAF_NODE_PENDING,
			SUPPLY_CLIENT_DATA_FROM_LEAF_NODE_IN_PROGRESS,
			SUPPLY_CLIENT_DATA_FROM_LEAF_NODE_COMPLETED,
		...
		enum Tag_type
		{
			...
			TAG_VBD_BLK_IO_SUPPLY_CLIENT_DATA,
			TAG_VBD_BLK_IO,
