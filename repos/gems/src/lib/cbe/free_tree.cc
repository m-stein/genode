                                        ...
                                        Generation         current_gen)
{
	...
	for (Node_index idx = 0; idx < NR_OF_TYPE_1_NODES_PER_BLK; idx++) {
                              ...
                              bool            &progress)
{
	...
	// handle level 1 - n
	for (Tree_level_index lvl = FIRST_LVL_N_STACKS_IDX; lvl <= LAST_LVL_N_STACKS_IDX; lvl++) {
                                ...
                                bool            &progress)
{
	...
	/* handle level 1..N */
	for (Tree_level_index l { FIRST_LVL_N_STACKS_IDX }; l <= LAST_LVL_N_STACKS_IDX; l++) {
