	...
	public:
		...
		~Benchmark()
		{
			...
			if (_num_virt_blks_read) {
				...
				Number_of_disk_bytes const bytes_read { _num_virt_blks_read * Tresor::BLOCK_SIZE };
			...
			if (_num_virt_blks_written) {
				...
				Number_of_disk_bytes bytes_written { _num_virt_blks_written * Tresor::BLOCK_SIZE };
