...
package CPP_Thread is
   ...
   with
      Import,
      Convention    => C,
      External_Name => "_ZN6Kernel6Thread26signal_context_kill_failedEv";

   procedure Signal_Context_Kill_Pending (Obj : Object_Reference_Type)
   with
      Import,
      Convention    => C,
      External_Name => "_ZN6Kernel6Thread27signal_context_kill_pendingEv";

   procedure Signal_Context_Kill_Done (Obj : Object_Reference_Type)
   with
      Import,
      Convention    => C,
      External_Name => "_ZN6Kernel6Thread24signal_context_kill_doneEv";
   ...
   with
      ...
      Convention    => C,
      External_Name =>
        "_ZN6Kernel6Thread21signal_receive_signalEPN6Genode14Signal_contextEj";

   procedure Signal_Wait_For_Signal (Obj : Object_Reference_Type)
   with
      Import,
      Convention    => C,
