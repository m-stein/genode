...
private
   ...
   pragma Atomic (Divide_Configuration_Register_Type);
   for Divide_Configuration_Register_Type'Size use 32;
   ...
   pragma Atomic (LVT_Entry_Type);
   for LVT_Entry_Type'Size use 32;
