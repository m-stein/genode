...
#ifndef _INCLUDE__ARM_V6__CPU__BARRIER_H_
#define _INCLUDE__ARM_V6__CPU__BARRIER_H_
...
namespace Genode
{
	 ...
	 */
	inline void arch_memory_barrier() {
...
#endif /* _INCLUDE__ARM_V6__CPU__BARRIER_H_ */
