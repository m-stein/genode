...
Hw::Pic::Pic()
:
	_distr({(char *)Board::Cpu_mmio::IRQ_CONTROLLER_DISTR_BASE, Board::Cpu_mmio::IRQ_CONTROLLER_DISTR_SIZE}),
	_redistr({(char *)Board::Cpu_mmio::IRQ_CONTROLLER_REDIST_BASE, Board::Cpu_mmio::IRQ_CONTROLLER_REDIST_SIZE}),
