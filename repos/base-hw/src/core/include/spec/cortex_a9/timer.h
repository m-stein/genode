...
class Genode::Timer : public Mmio
{
	...
	public:
		 ...
		 */
		void start_one_shot(duration_t const tics, unsigned const)
		{
		 ...
		 */
		duration_t value(unsigned const) { return read<Counter>(); }

		duration_t max_value() { return (Load::access_t)~0; }
};
