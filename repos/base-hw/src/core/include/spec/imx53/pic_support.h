...
#ifndef _SPEC__IMX53__PIC_SUPPORT_H_
#define _SPEC__IMX53__PIC_SUPPORT_H_
...
class Genode::Imx53_pic : public Mmio
{
	public:
	...
	public:
		 ...
		 */
		Imx53_pic() : Mmio(Board::TZIC_MMIO_BASE)
		{
...
#endif /* _SPEC__IMX53__PIC_SUPPORT_H_ */
