...
void Thread::await_signal(Signal_receiver * const receiver)
{
...
void Thread::receive_signal(void * const base, size_t const size)
{
...
: Core_object<Thread>("core")
{
	...
	Ada::assert_valid_object_size<Ada::Ipc_node>();
