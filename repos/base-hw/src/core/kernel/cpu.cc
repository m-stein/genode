...
duration_t Cpu_job::timeout_age_us(Timeout const * const timeout) const
{
	return _cpu->timeout_age_us(timeout);
}


duration_t Cpu_job::timeout_max() const
{
	return _cpu->timeout_max();
}


void Cpu_job::timeout(Timeout * const timeout, duration_t const us)
{
...
void Cpu::set_timeout(Timeout * const timeout, duration_t const duration_us)
{
	_clock.set_timeout(timeout, _clock.us_to_tics(duration_us));
}


duration_t Cpu::timeout_age_us(Timeout const * const timeout) const
{
	return _clock.timeout_age_us(timeout);
}


duration_t Cpu::timeout_max() const
{
	return _clock.timeout_max();
}
