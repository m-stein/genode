...
struct My::Avl_node : public My::Avl_node_base
{

	Avl_node(unsigned id) : Avl_node_base(id) { };
 ...
 */
template <typename NT>
class My::Avl_tree : public My::Avl_node<NT>
{
	private:
 ...
 */
template <typename NT>
struct Local::Avl_node : public My::Avl_node<NT>
{
	using Base = My::Avl_node<NT>;

	Avl_node(unsigned id) : My::Avl_node<NT>(id) { };
 ...
 */
template <typename NT>
struct Local::Avl_tree : public My::Avl_tree<NT>
{
	using Base = My::Avl_tree<NT>;
