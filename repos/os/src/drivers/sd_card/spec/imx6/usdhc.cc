/*
 * \brief  Freescale Ultra Secured Digital Host Controller
 * \author Martin Stein
 * \date   2016-12-13
 */
...
int
Esdhcv2_controller::_wait_for_cmd_complete_mb_finish(bool const reading)
{
...
bool
Esdhcv2_controller::_issue_cmd_finish_xfertyp(Xfertyp::access_t &,
                                              bool const         transfer,
